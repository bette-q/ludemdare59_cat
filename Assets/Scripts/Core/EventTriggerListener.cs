 ...
 public class EventTriggerListener : EventTrigger
 {
     ...
     [FormerlySerializedAs("onClick")] public VoidDelegate OnClick;
     [FormerlySerializedAs("onDown")] public EventDelegate OnDown;
     [FormerlySerializedAs("v")] public EventDelegate OnExit;
     [FormerlySerializedAs("onUp")] public EventDelegate OnUp;
     [FormerlySerializedAs("onSelect")] public VoidDelegate OnSelectEvent;

     [FormerlySerializedAs("onUpdateSelect")]
     public VoidDelegate OnUpdateSelect;

     [FormerlySerializedAs("onDragBegin")] public EventDelegate OnDragBegin;
     [FormerlySerializedAs("onDrag")] public EventDelegate OnDragEvent;
     [FormerlySerializedAs("onDragEnd")] public EventDelegate OnDragEnd;
     [FormerlySerializedAs("onEnter")] public EventDelegate OnEnter;
     [FormerlySerializedAs("onDrop")] public EventDelegate OnDropEvent;
     ...
     public static EventTriggerListener Get(GameObject go, float time = -1, bool play_ani = true, float scale = 1)
     {
         if (!go)
         {
             Debug.LogWarning("EventTriggerListener.Get, GameObject is null!!");
         }
